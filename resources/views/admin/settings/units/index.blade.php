...
@section('page_title') Չափման միավորների Ցանկ @stop
@section('content')
<div class="row">
                  <div class="col-12">
                     <div class="card">
                        <div class="card-body">
                        <a href="/admin/units/create" id="but_add" class="btn btn-primary float-right mb-5">Ստեղծել</a>
