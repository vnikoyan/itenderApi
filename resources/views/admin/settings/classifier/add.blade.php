                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card dr-pro-pic">
                                <div class="card-body">
                                    <div class="">
                                        {{ Form::model($classifier,array('route' => array('classifier.store'),'class'=>'form-horizontal form-material mb-0'))}}
                                            @method('POST')
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    {{ Form::select('cpv_id[]',[], $classifier->cpv_id, array('multiple'=>'multiple','class'=>'form-control select22'))}}
