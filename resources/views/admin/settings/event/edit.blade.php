                    ...
                    <div class="row">
                        <div class="col-lg-8 mx-auto">
                            <div class="card dr-pro-pic">
                                <div class="card-body">
                                    <div class="">
                                        {{ Form::model($event,array('route' => array('event.update',$event->id),'class'=>'form-horizontal form-material mb-0','files' => true))}}
                                            @method('PUT')
                                            ...
                                            <div class="form-group row">
                                                @foreach($event->medias as $key => $value)
                                                    <div class="col-xl-2" id="medit_{{$key}}">
                                                        @if($value->type == 1)
                                                            <img src="/uploads/event/{{$value->media}}" style="width: 100px;margin: 0 auto;display: block;height: 100px;object-fit: cover;">
                                                        @else
                                                            <video src="/uploads/event/{{$value->media}}"  style="width: 100px;margin: 0 auto;display: block;height: 100px;object-fit: cover;"></video>
                                                        @endif
                                                        <a href="#" data-href="/admin/event/image/delete/{{$value->id}}" data-remove="#medit_{{$key}}" class="btn btn-gradient-danger btn-sm text-light px-4 mt-3  mb-0 ml-2 deleteItem">X</a>
                                                    </div>
                                                @endforeach
                                            </div>
                                            <div class="form-group row">
