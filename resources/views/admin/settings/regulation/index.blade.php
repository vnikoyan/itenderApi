...
@section('breadcrumb_active') Կանոնակարգ @stop
@section('page_title') Կանոնակարգ @stop
@section('content')
<div class="row">
   <div class="col-12">
      <div class="card">
         <div class="card-body">
            ...
            {{ Form::model($regulation,array('route' => array('regulation.store'),'class'=>'form-horizontal form-material mb-0','files' => true))}}
               <div class="col-md-12 form-group">
                  <label for="" class="">Կանոնակարգ</label>
                  <textarea style="resize: none;min-height: 600px;" name="description" class="form-control html">
