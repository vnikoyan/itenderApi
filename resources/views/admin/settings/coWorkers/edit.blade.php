...
@section('page_title') Գործընկերների  @stop
                    ...
                    <div class="row">
                        <div class="col-lg-8 mx-auto">
                            <div class="card dr-pro-pic">
                                <div class="card-body">
                                    <div class="">
                                        {{ Form::model($coworkers,array('route' => array('co_workers.update',$coworkers->id),'class'=>'form-horizontal form-material mb-0','files' => true))}}
                                            @method('PUT')
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <img src="/uploads/coWorkers/{{$coworkers->image}}">
                                                        </div>
                                                    </div>
                                                </div>  
                                            </div>
