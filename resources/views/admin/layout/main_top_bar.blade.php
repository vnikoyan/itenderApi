                ...
                <ul class="list-unstyled topbar-nav float-right mb-0">
                    ...
                    {{-- <li class="dropdown notification-list">
                        <a class="nav-link dropdown-toggle arrow-none waves-light waves-effect" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                            <i class="ti-bell noti-icon"></i> <span class="badge badge-danger badge-pill noti-icon-badge">2</span>
                        </a>
                    ...
                    <li class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a class="dropdown-item" href="/admin/logout"><i class="dripicons-exit text-muted mr-2"></i>Ելք համակարգից </a>
                        </div>
                    </li>
                    {{-- <li class="mr-2">
                ...
                <ul class="list-unstyled topbar-nav mb-0">
                    {{-- <li>
                        <a href="../crm/crm-index.html">
                            <span class="responsive-logo"><img src="/assets/back/assets/images/logo-sm.png" alt="logo-small" class="logo-sm align-self-center" height="34" /></span>
                        </a>
                    </li> --}}
                    <li>
