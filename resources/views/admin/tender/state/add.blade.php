...
@if(!empty(Request::get('type')) && Request::get('type') == 4  )
    @section('breadcrumb_active') Ստեղծել / Ոչ Մրցույթներ @stop
@else
    @section('breadcrumb_active') Ստեղծել / Մրցույթներ @stop
@endif
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card dr-pro-pic">
                <div class="card-body">
                    <div class="">
                        {{ Form::model($tenderState,array('route' => array('tender_state.store'),'class'=>'form-horizontal form-material mb-0','files' => true))}}
                            @method('POST')
                            ...
                            <input type="hidden" class="cpv_codes_with_slash">
                            <input type="hidden" class="tender-id" value="{{$tenderState->id}}">
                            <div class="form-group row">
                             <div class="col-md-10">
                                    <label for="" class="">Պատվիրատու<span style="color:red;font-size:12px">*</span></label>
                                    <select class="select2 form-control" name="organizator" id="organizator-sel">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-6">
                                            ...
                                            <input type="date" name="start_date" required placeholder="Սկիզբ" class="form-control">
                                            <input type="text" name="start_time" required placeholder="13:00" class="form-control">
                                        </div>
                                        <div class="col-md-6">
                                            <label for="" class="" style ="display:block;">Ավարտ<span style="color:red;font-size:12px">*</span></label>
                                            <input type="date" name="end_date" required placeholder="Սկիզբ" class="form-control">
                                            <input type="text" name="end_time" required placeholder="14:00" class="form-control">
                                        </div>
                                        {{-- <div class="col-md-6">
                                            ...
                                            {{ Form::dateTime('end_date', $tenderState->end_date, ["required"=>"required","class"=>"form-control endDataTime","placeholder"=>"Ավարտ","disabled"=>"disabled"])}}
                                            <p style="color:red;width: 100%;"> {{ $errors->first('end_date') }} </p>
                                        </div>  --}}
                                    </div>
                                    <div class="d-flex">
                                        <div class="col-md-2 mt-2 mb-4 is_competition_section">
                                            <input type="checkbox" name="is_competition" id="is_competition" value="1"> <label for="is_competition" class=""> Մրցույթ է</label>
                                            <input type="hidden" name="is_competition" value="1" id = "is_competition_hidden">
                                        </div>
                                        <div class="col-md-2  mt-2 mb-4" style = "display: none;">
                                        ...
                                        <div class="col-md-2 mt-2 mb-4">
                                            <input type="checkbox" name="is_closed"  {{ ($tenderState->is_closed == "1" ? "checked":"") }}  id="is_closed" value="1"> <label for="" class=""> Բաց է</label>
                                        </div>
                                        <div class="col-md-2 mt-2 mb-4">
                                            <input type="checkbox" name="kind" id="kind" value="{{ $tenderState->kind }}"> <label for="kind" > Միջազգային </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-4 mt-2 mb-2" id="region-sel">
                                            <label for="" class="" >Մարզեր<span  class = "required-fields" style="color:red;font-size:12px">*</span></label>
                                            <select class=" form-control" required='required' name="regions" value ="0">
                                                <option value="">-- Ընտրել --</option>
                                        ...
                                        <div class="col-md-4 mt-2 mb-2">
                                            ...
                                            <select class=" form-control tender-type" required='required' name="type">
                                                <option value="">-- Ընտրել --</option>
                                                <option {{ ($tenderState->type == "ELECTRONIC" ? "selected":"") }} value="PAPER">Թղթային</option>
                                                <option {{ ($tenderState->type == "PAPER" ? "selected":"") }} value="ELECTRONIC">Էլեկտրոնային (armeps)</option>
                                        ...
                                        <div class="col-md-12 mt-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="file" required="required" name="invitation_file" style="padding-top: 3px;" class="form-control">
                                            </div>
                                        </div>
                                        <div class = "col-md-12">
                                            <div class = "row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="passwordTender"  required='required'  value='{{ $tenderState->passwordTender }}' class="form-control" style="margin-bottom: 5px;" >
...
var urlRegex = /(\d+)$/;
urlRegex = location.href.match(urlRegex);
if(urlRegex[1] == 3){
    $(".searchTenderState-section").hide();
    $("#is_competition").attr('disabled','disabled').attr('checked', 'checked');
    $("#is_new").parent().show();
...
$(document).on("input", ".cpv-table .select2-search__field", function () {
    ...
    $("#organizator-sel").change( function(){
    ...
    $(".searchTenderState-sel").change(function(){
        ...
        var val = $("#organizator-sel").find(":selected").val().split(',');
        if(val[1] == 2){
             $("input[name='passwordTender']").removeAttr("required");
             $("select[name='procedure']").removeAttr("required");
             $("select[name='regions']").removeAttr("required");
                    ...
                    if(data[index].cpv_id != 0){
                        ...
                        $(".cpv-table").append(`
                            <tr data-key=${index} data-id=${data[index].id}>
                                ...
                                <td><input class="specification" type='text'></td>
    ...
    $("#is_competition").change(function(){
        if(this.checked) {
            ...
            if(urlRegex[1] == 3){
                ...
                $(".searchTenderState-section").show();
            }
            $("#is_new").parent().hide();
            $(".beneficiari").parent().hide();
            $(".beneficiari").removeAttr('checked');
            $(".is_with_model").parent().show();
            $(".is_with_model").attr('checked','checked');
    ...
    $("#kind").change(function(){
        if( $('#kind').is(':checked')) {
            $("#region-sel  select ").attr("disabled","disabled");
        }else{
            $("#region-sel  select ").removeAttr("disabled");
        }
    })
    ...
    $('.startDataTime').bootstrapMaterialDatePicker({
        ...
        $('.endDataTime').removeAttr("disabled");
