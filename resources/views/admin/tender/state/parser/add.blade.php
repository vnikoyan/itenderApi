    ...
    <div class="row">
        <div class="col-lg-8 mx-auto">
            <div class="card dr-pro-pic">
                <div class="card-body">
                    <div class="">
                        {{ Form::model($info,array('route' => array('info.store'),'class'=>'form-horizontal form-material mb-0','files' => true))}}
                            @method('POST')
                            ...
                            <div class="form-group row">
                                <div class="col-md-3">
                                    {{ Form::text('order', $info->order, ["class"=>"form-control","placeholder"=>"order"])}}
