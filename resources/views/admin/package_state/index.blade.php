...
@section('breadcrumb_active') Պետական փաթեթներ @stop
                     ...
                     <div class="card">
                        <div class="card-body">
                           <div class="table-responsive">
                              <a href="/admin/package_state/create" id="but_add" class="btn btn-primary float-right mb-5">Ստեղծել</a>
...
<script>
    $(document).ready(function () {
        $("#datatable-buttons").DataTable({
            processing: true,
            ajax: '/admin/package_state/tableData',
            columns: [
                { data: 'name', name: 'name'},
