                    ...
                    <div class="row">
                        <div class="col-lg-8 mx-auto">
                            <div class="card dr-pro-pic">
                                <div class="card-body">
                                    <div class="">
                                        {{ Form::model($packages,array('route' => array('package_state.update',$packages->id),'class'=>'form-horizontal form-material mb-0'))}}
                                            @method('PUT')
                                            <div class="form-group row">
                                                <div class="col-md-4">
                                                   <label for="" class="">Անվանում</label>
                                                    <input type="text" name="name" class="form-control" value="{{ $packages->name}}">
                                                    @if($errors->has('name'))
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="number" name="price" class="form-control" value="{{ $packages->price}}">
                                                    @if($errors->has('price'))
