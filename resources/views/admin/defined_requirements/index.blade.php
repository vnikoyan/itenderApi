...
@section('page_title') Սահմանվող պահանջներ Ցանկ @stop
@section('content')
<div class="row">
   <div class="col-12">
      <div class="card">
         <div class="card-body">
         <a href="/admin/defined_requirements/create" id="but_add" class="btn btn-primary float-right mb-5">Ստեղծել</a> 
...
<script>
    $(document).ready(function () {
        $("#datatable-buttons").DataTable({
            processing: true,
            serverSide: true,
            ajax: '/admin/defined_requirements/tableData',
            columns: [
