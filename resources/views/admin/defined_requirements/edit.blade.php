                    ...
                    <div class="row">
                        <div class="col-lg-8 mx-auto">
                            <div class="card dr-pro-pic">
                                <div class="card-body">
                                    <div class="">
                                        {{ Form::model($defined_requirements,array('route' => array('defined_requirements.update',$defined_requirements->id),'class'=>'form-horizontal form-material mb-0'))}}
                                            @method('PUT')
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    {{ Form::select('cpv_id',$cpv, $defined_requirements->cpv_id, array('class'=>'form-control select22'))}}
