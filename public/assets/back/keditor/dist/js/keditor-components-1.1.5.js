...
(function ($) {
  ...
  CKEDITOR.filebrowserImageBrowseUrl = '/laravel-filemanager?type=Images';
  CKEDITOR.filebrowserImageUploadUrl   = '/laravel-filemanager/upload?type=Images&_token={{csrf_token()}}';

  CKEDITOR.dtd.$removeEmpty.span = 0;
  CKEDITOR.dtd.$removeEmpty.i = 0;
  CKEDITOR.filebrowserBrowseUrl        = '/laravel-filemanager?type=Files';
  CKEDITOR.filebrowserUploadUrl        = '/laravel-filemanager/upload?type=Files&_token={{csrf_token()}}';
KEditor.filebrowserImageBrowseUrl = '/laravel-filemanager?type=Images';
  KEditor.filebrowserImageUploadUrl   = '/laravel-filemanager/upload?type=Images&_token={{csrf_token()}}';
  KEditor.filebrowserBrowseUrl        = '/laravel-filemanager?type=Files';
  KEditor.filebrowserUploadUrl        = '/laravel-filemanager/upload?type=Files&_token={{csrf_token()}}';
...
(function ($) {
    ...
    KEditor.components['slder'] = {
        getContent: function (component, keditor) {
            flog('getContent "slder" component', component);
