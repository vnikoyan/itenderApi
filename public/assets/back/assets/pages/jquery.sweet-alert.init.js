    ...
    (e.prototype.init = function () {
        t("#sa-basic").on("click", function () {
            ...
            t("#sa-image").click(function () {
                Swal.fire({ title: "Metrica", text: "Modal with a custom image.", imageUrl: "../../assets/images/logo-sm.png", imageHeight: 80, animation: !1 });
            }),
            ...
            t("#custom-padding-width-alert").click(function () {
                Swal.fire({ title: "Custom width, padding, background.", width: 600, padding: 100, background: "$card-bg url(../../assets/images/pattern.png)" });
            }),
