...
class UnApprovedType121 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'unapproved:type121';

    protected $url      = "http://gnumner.am/";
    protected $phat_hy  = "/hy/page/gnman_gortsyntacneri_kazmakerpman_masin_haytararutyunner/";
    protected $phat_ru  = "/ru/page/obyavleniya_ob_organizatcii_zakupochnykh_protcedur/";
    protected $phat_en  = "/en/page/announcements_on_organizing_procurement_procedure/";
    protected $type     = "12";
    protected $client   = "";
    /**
     ...
     * @var string
     */
    protected $description = 'Հանրային կազմակերպությունների կողմից կատարվող գնումների վերաբերյալ հայտարարություններ';
