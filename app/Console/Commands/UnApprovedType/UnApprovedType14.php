...
class UnApprovedType14 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'unapproved:type14';

    protected $url      = "http://gnumner.am/";
    protected $phat_hy  = "/hy/page/gnanshman_harcman_haytararutyun_ev_hraver/";
    protected $phat_ru  = "/ru/page/obyavlenie_i_priglashenie_po_zaprosu_kotirovok/";
    protected $phat_en  = "/en/page/announcement_and_invitation_at_the_request_of_quotation/";
    protected $type     = "14";
    protected $client   = "";
    /**
     ...
     * @var string
     */
    protected $description = 'Գնանշման հարցման հայտարարություն և հրավեր';
