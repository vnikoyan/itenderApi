...
class UnApprovedType10 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'unapproved:type10';

    protected $url      = "http://gnumner.am/";
    protected $phat_hy  = "/hy/page/otarerkrya_petutyunneri_koghmic_kazmakerpvogh_gnumner/";
    protected $phat_ru  = "/ru/page/zakupki_provodimye_v_zarubezhnykh_stranakh/";
    protected $phat_en  = "/en/page/procurements_organized_fy_foreign_states/";
    protected $type     = "10";
    protected $client   = "";
    /**
     ...
     * @var string
     */
    protected $description = 'Օտարերկրյա պետությունների կողմից կազմակերպվող գնումներ';
