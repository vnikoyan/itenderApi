...
class UnApprovedType123 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'unapproved:type123';

    protected $url      = "http://gnumner.am/";
    protected $phat_hy  = "/hy/page/paymanagir_knqelu_masin_haytararutyunner_1/";
    protected $phat_ru  = "/ru/page/obyavleniya_o_podpisannykh_kontraktakh_1/";
    protected $phat_en  = "/en/page/_announcements_of_signing_contracts_1/";
    protected $type     = "12";
    protected $client   = "";
    /**
