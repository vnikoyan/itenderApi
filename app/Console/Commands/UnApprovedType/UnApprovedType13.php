...
class UnApprovedType13 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'unapproved:type13';

    protected $url      = "http://gnumner.am/";
    protected $phat_hy  = "/hy/page/bac_mrcuyti_haytararutyun_ev_hraver/";
    protected $phat_ru  = "/ru/page/obyavlenie_i_priglashenie_na_otkrytyi_konkurs/";
    protected $phat_en  = "/en/page/announcement_and_invitation_of_an_open_tender/";
    protected $type     = "13";
    protected $client   = "";
    /**
     ...
     * @var string
     */
    protected $description = 'Բաց մրցույթի հայտարարություն և հրավեր';
