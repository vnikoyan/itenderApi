...
class UnApprovedType2 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'unapproved:type2';

    protected $url = "http://gnumner.am/";
    protected $phat_hy = "/hy/page/erkpul_mrcuyti_nakhaorakavorman_haytararutyun/";
    protected $phat_ru = "/ru/page/predkvalifikatcionnoe_obyavlenie_na_dvukhetapnyi_otkrytyi_konkurs/";
    protected $phat_en = "/en/page/prequalification_announcement_of_the_two-stage_open_tender/";
    protected $type = "2";
     ...
     * @var string
     */
    protected $description = 'Երկփուլ մրցույթի նախաորակավորման հայտարարություն ';
