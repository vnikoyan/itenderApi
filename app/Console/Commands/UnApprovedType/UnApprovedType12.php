...
class UnApprovedType12 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'unapproved:type12';

    protected $url      = "http://gnumner.am/";
    protected $phat_hy  = "/hy/page/hravernerum_katarvats_popokhutyunner_1/";
    protected $phat_ru  = "/ru/page/izmeneniya_vnesennye_v_priglashenie_1/";
    protected $phat_en  = "/en/page/hravernerum_katarvats_popokhutyunner_1/";
    protected $type     = "12";
    protected $client   = "";
    /**
