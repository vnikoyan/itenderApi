...
class UnApprovedType122 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'unapproved:type122';

    protected $url      = "http://gnumner.am/";
    protected $phat_hy  = "/hy/page/gnahatogh_handznazhoghovi_nisteri_ardzanagrutyunner/";
    protected $phat_ru  = "/ru/page/gnahatogh_handznajoghov/";
    protected $phat_en  = "/en/page/gnahatogh_handznajoghov/";
    protected $type     = "12";
    protected $client   = "";
    /**
