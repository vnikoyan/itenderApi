...
class UnApprovedType5 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'unapproved:type5';

    protected $url = "http://gnumner.am/";
    protected $phat_hy = "/hy/page/_pak_npatakayin_mrcuyti_nakhaorakavorman_haytararutyun/";
    protected $phat_ru = "/ru/page/predkvalifikatcionnoe_obyavlenie_na_zakrytyi_tcelevoi_konkurs/";
    protected $phat_en = "/en/page/prequalification_announcement_of_the_target_closed_tender/";
    protected $type = "5";
    protected $client = "";
     ...
     * @var string
     */
    protected $description = 'Փակ նպատակային մրցույթի նախաորակավորման հայտարարություն';
