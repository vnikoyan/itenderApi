...
class UnApprovedType6 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'unapproved:type6';

    protected $url = "http://gnumner.am/";
    protected $phat_hy = "/hy/page/pak_parberakan_mrcuyti_nakhaorakavorman_haytararutyun_ev_hraver/";
    protected $phat_ru = "/ru/page/predkvalifikatcionnoe_obyavlenie_i_priglashenie_na_zakrytyi_periodicheskii_konkurs/";
    protected $phat_en = "/en/page/prequalification_announcement_and_invitation_of_the_closed_periodic_tender/";
    protected $type = "6";
    protected $client = "";
     ...
     * @var string
     */
    protected $description = 'Փակ պարբերական մրցույթի նախաորակավորման հայտարարություն և հրավեր';
