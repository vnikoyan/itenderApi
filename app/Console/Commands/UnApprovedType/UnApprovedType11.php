...
class UnApprovedType11 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'unapproved:type11';

    protected $url      = "http://gnumner.am/";
    protected $phat_hy  = "/hy/page/mayr_ator_s_ejmiatsni_haytararutyunner/";
    protected $phat_ru  = "/ru/page/obyavleniya_pervoprestolnyi_echmiadzina/";
    protected $phat_en  = "/en/page/announcements_of_mother_see_of_holy_etchmiadzin/";
    protected $type     = "11";
    protected $client   = "";
    /**
     ...
     * @var string
     */
    protected $description = 'Մայր Աթոռ Ս. Էջմիածնի հայտարարություններ';
