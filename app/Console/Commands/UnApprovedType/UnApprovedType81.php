...
class UnApprovedType81 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'unapproved:type81';

    protected $url      = "http://gnumner.am/";
    protected $phat_hy  = "/hy/page/knqvats_paymanagreri_masin_haytararutyunner/";
    protected $phat_ru  = "/ru/page/obyavleniya_o_podpisannykh_kontraktakh/";
    protected $phat_en  = "/en/page/_announcements_on_signed_contracts/";
    protected $type     = "8";
    protected $client   = "";
    /**
