...
class UnApprovedType124 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'unapproved:type124';

    protected $url      = "http://gnumner.am/";
    protected $phat_hy  = "/hy/page/chkayacats_yntacakargi_haytararutyunner/";
    protected $phat_ru  = "/ru/page/obyavlenie_o_nesostoyavsheisya_protcedure_zakupki/";
    protected $phat_en  = "/en/page/chkajacac_haytararutyunner/";
    protected $type     = "12";
    protected $client   = "";
    /**
