...
class UnApprovedType4 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'unapproved:type4';

    protected $url = "http://gnumner.am/";
    protected $phat_hy = "/hy/page/gnanshman_harcman_nakhaorakavorman_haytararutyun/";
    protected $phat_ru = "/ru/page/zapros_tcenovykh_predlozhenii/";
    protected $phat_en = "/en/page/quotation_request/";
    protected $type = "4";
    protected $client = "";
     ...
     * @var string
     */
    protected $description = 'Գնանշման հարցման նախաորակավորման հայտարարություն';
