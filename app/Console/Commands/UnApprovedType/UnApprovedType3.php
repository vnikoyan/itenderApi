...
class UnApprovedType3 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'unapproved:type3';

    protected $url = "http://gnumner.am/";
    protected $phat_hy = "/hy/page/bac_mrcuyti_nakhaorakavorman_haytararutyun/";
    protected $phat_ru = "/ru/page/predkvalifikatcionnoe_obyavlenie_na_otkrytyi_konkurs/";
    protected $phat_en = "/en/page/open_tender_prequalification_announcement_/";
    protected $type = "3";
     ...
     * @var string
     */
    protected $description = 'Բաց մրցույթի նախաորակավորման հայտարարություն';
