...
class UnApprovedType7 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'unapproved:type7';

    protected $url = "http://gnumner.am/";
    protected $phat_hy = "/hy/page/_mek_andzic_gnumneri_katarman_haytararutyun_ev_hraver/";
    protected $phat_ru = "/ru/page/obyavlenie_i_priglashenie_na_zakupku_iz_odnogo_istochnika/";
    protected $phat_en = "/en/page/announcement_and_invitation_on_single-source_procurement_/";
    protected $type = "7";
    protected $client = "";
     ...
     * @var string
     */
    protected $description = 'Մեկ անձից գնումների կատարման հայտարարություն և հրավեր';
    ...
    {
        parent::__construct();
        $client = new Client(HttpClient::create(['timeout' => 6000000]));
        $this->client = $client;
    }
