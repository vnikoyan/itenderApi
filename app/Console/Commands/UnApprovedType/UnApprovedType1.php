...
class UnApprovedType1 extends Command
{
    /**
     ...
     * @var string
    */
    protected $signature = 'unapproved:type1';

    protected $url = "http://gnumner.am/";
    protected $phat_hy = "/hy/page/elektronayin_achurdi_haytararutyun_ev_hraver/";
    protected $phat_ru = "/ru/page/obyavlenie_i_priglashenie_na_elektronnyi_auktcion/";
    protected $phat_en = "/en/page/announcement_and_invitation_of_an_electronic_auction/";
    protected $type = "1";
