...
/**
 * @OA\Schema(
 *     title="CreateOrganize",
 *     description="CreateOrganize API",
 *     @OA\Xml(
 *         name="CreateOrganize"
 *     )
 * )
...
interface CreateOrganize
{
     ...
     *                           description="Վճարումն անհրաժեշտ է իրականացնել",
     *                           example="42424242424242"
     *                      ),
     *                      @OA\Property(
     *                           title="evaluator_president",
     *                           property="evaluator_president",
     *                           description="Նախագահ",
     *                           example={"hy":"name","ru":"name"}
     *                      ),
     *                      @OA\Property(
